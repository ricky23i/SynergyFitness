...
public class AboutMeControllerTest {
	...
	@Autowired
	private AboutMeController boutMeCtrl;
	...
	@Test
	public void getAvailableAboutMes() throws Exception {
		when(userServ.viewAboutMes()).thenReturn(Collections.emptyList());
	...
	@Test
	public void addAboutMeSuccessfully() throws Exception {
		AboutMe aboutMe = new AboutMe();
		when(trainServ.addAboutMe(aboutMe)).thenReturn(1);
		
		String jsonPet = objMapper.writeValueAsString(aboutMe);
